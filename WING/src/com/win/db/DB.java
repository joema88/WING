...
public class DB {
	...
	public static void main(String[] args) {
		 ...
		 * (DATEID)); 
		 * 3. CREATE TABLE BBROCK(STOCKID SMALLINT, DATEID SMALLINT, PERCENT FLOAT, CLOSE FLOAT,NETCHANGE FLOAT, ATR FLOAT, OPEN FLOAT,HIGH FLOAT, LOW FLOAT,LOW52 FLOAT,HIGH52 FLOAT, MARKCAP FLOAT,VOLUME INT, YELLOW TINYINT,TEAL TINYINT, PINK TINYINT, BB1 SMALLINT, BB2 SMALLINT, BB3 SMALLINT, BB4 SMALLINT,BB5 SMALLINT DEFAULT 0, BB6 SMALLINT DEFAULT 0,BB7 SMALLINT DEFAULT 0,BB8 SMALLINT DEFAULT 0, PTVAL FLOAT DEFAULT 0.0, PTCP FLOAT DEFAULT 0.0, PRIMARY KEY (STOCKID, DATEID), FOREIGN KEY (STOCKID) REFERENCES SYMBOLS(STOCKID) ON DELETE CASCADE, FOREIGN KEY (DATEID) REFERENCES DATES(DATEID));
		 */
		//select a.DATEID,CDATE, a.STOCKID, CLOSE, TEAL, YELLOW, PINK, MARKCAP, VOLUME FROM BBROCK a, SYMBOLS b, DATES c  WHERE a.STOCKID = b.STOCKID and a.DATEID=c.DATEID and b.SYMBOL='BRK/A';
		// $$$$$$$$$ SQL
