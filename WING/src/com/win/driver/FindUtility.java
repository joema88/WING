...
public class FindUtility {
	...
	public static void searchMethod2() {
		...
		Hashtable result1 = DBSearch.findQualifiedStocks(day1Condition);
		...
		Hashtable result2 = DBSearch.findQualifiedStocks(day2Condition);
		...
		Hashtable result3 = DBSearch.findQualifiedStocks(day3Condition);
		...
		Hashtable result4 = DBSearch.findQualifiedStocks(day4Condition);
